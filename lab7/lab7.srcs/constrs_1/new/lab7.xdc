...
set_property -dict { PACKAGE_PIN T13   IOSTANDARD LVCMOS33 } [get_ports { reset }]; #IO_L23P_T3_A03_D19_14 Sch=sw[11]
set_property -dict { PACKAGE_PIN H6    IOSTANDARD LVCMOS33 } [get_ports { write }]; #IO_L24P_T3_35 Sch=sw[12]
